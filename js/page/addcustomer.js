...
bread.innerHTML = `<a href="CustomerList.html">Customer</a> <span>Add customer</span>`;
...
function updatePage(number) {
  try {
          ...
          <table width="90%">
           <tr>
            <td align="left" width="40%">
             <h2 class="title-shop-page">Add Customer </h2>
     ...
     <div class="item-product-list">
                ...
                <div class="row">
                 <div class="newsletter-form footer-box">
                   <h2 class="title14">Last Name</h2>
                       <input type="text" id = "clname" value="">
                 </div>
                </div>
               </div>
               <div class="footer-list-box">
                ...
                <div class="row">
                 <div class="newsletter-form footer-box">
                   <h2 class="title14">Usernumber</h2>
                       <input type="text" id = "cnumbers" value="">
                 </div>
                </div>
               </div>
              </table>
           ...
           <td align="center">
            <table width="90%">
             <div class="footer-list-box">
              <div class="row">
               <div class="newsletter-form footer-box">
                 <h2 class="title14">Sale Employee Number</h2>
                     <input type="text" id = "sen" >
               </div>
              </div>
             </div>
            </table>
              ...
              <div class="row">
               <div class="newsletter-form footer-box">
                 <h2 class="title14">Credit Limit</h2>
                     <input type="text" id = "ccredit" value="">
               </div>
              </div>
             </div>
            </table>
             ...
             <div class="row">
              <div class="newsletter-form footer-box">
                <h2 class="title14">AddressLine1</h2>
                    <input type="text" id = "caddr1" value="">
              </div>
             </div>
            </div>
            <div class="footer-list-box">
             <div class="row">
              <div class="newsletter-form footer-box">
                <h2 class="title14">AddressLine2</h2>
                    <input type="text" id = "caddr2" value="">
              </div>
             </div>
            </div>
            <div class="footer-list-box">
            ...
            <div class="newsletter-form footer-box">
               ...
               <div class="newsletter-form footer-box">
                   <h2 class="title14">PostalCode</h2>
                       <input type="text" id = "postal" value="">
               </div>
            </div>
            </div>
           </table>
      ...
      <tr>
      <td align="center">
      <button type="button" class="btn btn-secondary btn-lg btn-block cancle" id = "cancle" onclick ="">Cancal</button>
      </td>
      </tr>
  </table>
  <table align="center" width='40%'>
      <tr>
      <td align="left">
      <button type="button" class="btn btn-warning btn-lg btn-block updatevalue" id = "save" onclick = "">Save</button>
      </td>
      </tr>
      <br>
  </table>
