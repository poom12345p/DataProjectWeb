              ...
              <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="product-info">
                  <h3 class="product-title"><a
                      href="http://demo.7uptheme.com/html/kuteshop/detail.html">Order
                      : ${dataMem[i].orderNumber}</a></h3>
                  <div class="product-price">
                    <ins><span>$${dataMem[i].priceEach}</span></ins>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <h5 class="desc">${dataMem[i].status}</h5>
                    <h6 class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h6>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <h5 class="desc">Address</h5>
                    <h6 class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h6>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <h5 class="desc">Transport</h5>
                    <h6 class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h6>
                  </div>
                </div>
              </div>
